/**
 * v0 by Vercel.
 * @see https://v0.dev/t/iAHEtPNkbHj
  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1 bg-custom-gradient">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-custom-gradient dark:bg-gray-800">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>+91 (555) 555-5555</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <MailIcon className="h-5 w-5" />
                    <span>admin@safelink.in</span>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
